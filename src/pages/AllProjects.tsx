      ...
      <section className="py-32 max-w-[1440px] mx-auto px-8 lg:px-16">
        ...
        >
          ...
          <p className="text-[#6B6B6B] text-base leading-relaxed max-w-2xl">
            Explore our portfolio of 15+ delivered projects spanning diverse industries. Each project represents our commitment to excellence, innovation, and client success.
          </p>
        </motion.div>
